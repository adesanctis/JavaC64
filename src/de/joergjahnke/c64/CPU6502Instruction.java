...
public class CPU6502Instruction {
     ...
     */
    public CPU6502Instruction(final String name, final short opCode, final int opGroup, final int addressMode, final int cycles, final boolean addPageBoundaryCycle) {
        this.name = name;
        this.opCode = opCode;
     ...
     * @param   cycles  number of CPU cycles the operation takes
     */
    public CPU6502Instruction(final String name, final short opCode, final int opGroup, final int addressMode, final int cycles) {
     ...
     * @param   opCode  6510 op-code for the instruction
     */
    public CPU6502Instruction(final CPU6502Instruction instruction, final short opCode) {
