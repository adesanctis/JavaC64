...
public class CIA6526_2 extends CIA6526 {
    ...
    public int readRegister(final int register) {
        switch (register) {
            case PRA:
                return (short) ((super.readRegister(register) & 0x3f) | (this.c64.getIECBus().getSignal(IECBus.CLK) ? 0 : SB_CLK_IN) | (this.c64.getIECBus().getSignal(IECBus.DATA) ? 0 : SB_DATA_IN));
