...
public class VIA6522 implements IOChip, Serializable {
     ...
     */
    protected final int IRQ_TRANSITION_CA2 = 0x01;
    /**
     * IRQ line for a transition on CA1
     */
    protected final int IRQ_TRANSITION_CA1 = 0x02;
    /**
     * IRQ line for a completion of eight shifts
     */
    protected final int IRQ_SHIFT_COMPLETION = 0x04;
    /**
     * IRQ line for a transition on CB2
     */
    protected final int IRQ_TRANSITION_CB2 = 0x08;
    /**
     * IRQ line for a transition on CB1
     */
    protected final int IRQ_TRANSITION_CB1 = 0x10;
    /**
     * IRQ line for a timeout of timer B
     */
    protected final int IRQ_TIMEOUT_TIMER_B = 0x20;
    /**
     * IRQ line for a timeout of timer A
     */
    protected final int IRQ_TIMEOUT_TIMER_A = 0x40;
    /**
    ...
    public int readRegister(final int register) {
        switch (register) {
            ...
            case IFR:
                return (short) (this.registers[IFR] | ((this.registers[IFR] & this.registers[IER]) != 0 ? 0x80 : 0));

            case IER:
                return (short) (this.registers[IER] | 0x80);
    ...
    public void update(final long cycles) {
        ...
        this.registers[TIMER_A_LOW] = (short) (ta & 0xff);
        this.registers[TIMER_A_HIGH] = (short) (ta >> 8);
        ...
        if ((this.registers[ACR] & 0x20) == 0) {
            ...
            this.registers[TIMER_B_LOW] = (short) (tb & 0xff);
            this.registers[TIMER_B_HIGH] = (short) (tb >> 8);
        }
