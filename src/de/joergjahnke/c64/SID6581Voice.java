...
public class SID6581Voice implements IOChip, Serializable, FrequencyDataProducer {
    ...
    /**
     * C64's CPU, we need this to determine the current CPU cycle every now and then
     */
    private final CPU6502 cpu;
    /**
     * registers of the SID
     */
    protected final short[] registers;
    /**
    ...
    public SID6581Voice(final SID6581 sid, final int offset) {
        ...
        this.cpu = sid.c64.getCPU();
        this.offset = offset;
        this.nextUpdate = cpu.getCycles();
     ...
     */
    protected short getEnvelopeOutput() {
        return (short) this.envelopeOutput;
    }
        ...
        if (cycles >= getNextUpdate()) {
            ...
            switch (this.envelopePhase) {
                ...
                case RELEASE:
                    ...
                    this.envelopeOutput *= getReleaseRate();
    ...
    class TriangleWaveForm extends WaveForm {
        ...
        public final int getOutput(final int n) {
            return n < sid.getSampleRate() / 2 ? 0xfff * 2 * n / sid.getSampleRate() : 0xfff * 2 * (sid.getSampleRate() - n) / sid.getSampleRate();
        }
    }
