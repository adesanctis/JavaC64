...
public class C64CPU6510 extends CPU6502 {
            ...
            case 0xd000:
                if (this.isIOActive) {
                    switch (address & 0xff00) {
                        ...
                        case 0xd200:
                        case 0xd300:
                            return (short)this.c64.getVIC().readRegister(address & 0x3f);
                        ...
                        case 0xd600:
                        case 0xd700:
                            return (short)this.c64.getSID().readRegister(address & 0x1f);
                        ...
                        case 0xda00:
                        case 0xdb00:
                            return (short)this.memory[COLOR_RAM_OFFSET + address];

                        // CIA#1-related
                        case 0xdc00:
                            return (short)this.c64.getCIA(0).readRegister(address & 0x0f);

                        // CIA#2-related
                        case 0xdd00:
                            return (short)this.c64.getCIA(1).readRegister(address & 0x0f);
            ...
            case 0xd000:
                ...
                if (this.isIOActive) {
                    switch (address & 0xff00) {
                        ...
                        case 0xd200:
                        case 0xd300:
                            this.c64.getVIC().writeRegister(address & 0x3f, data);
                            break;
                        ...
                        case 0xd600:
                        case 0xd700: {
                            this.c64.getSID().writeRegister(address & 0x1f, data);
                            break;
                        }
                        ...
                        case 0xdc00:
                            this.c64.getCIA(0).writeRegister(address & 0x0f, data);
                            break;

                        // CIA#2-related address
                        case 0xdd00:
                            this.c64.getCIA(1).writeRegister(address & 0x0f, data);
                            break;
    ...
    public void reset() {
        ...
        writeByte(0, (short) 0x2f);
        writeByte(1, (short) 0x37);
