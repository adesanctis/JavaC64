...
public class C64FileEntry {
     ...
     */
    public final String TYPE_DELETED = "DEL";
    /**
     * File type for a program file
     */
    public final String TYPE_PROGRAM = "PRG";
    /**
     * File type for a sequential file
     */
    public final String TYPE_SEQUENTIAL = "SEQ";
    /**
     * File type for a user file
     */
    public final String TYPE_USER = "USR";
    /**
     * File type for a relative file
     */
    public final String TYPE_RELATIVE = "REL";
    /**
     * Unknown file type
     */
    public final String TYPE_UNKNOWN = "   ";
    /**
