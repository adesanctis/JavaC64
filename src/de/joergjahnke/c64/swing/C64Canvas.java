...
public class C64Canvas extends JPanel implements Observer, KeyListener, MouseListener {
    ...
    static {
        ...
        keycodeKeyMap.put(new Integer(KeyEvent.VK_LEFT), "LEFT");
        keycodeKeyMap.put(new Integer(KeyEvent.VK_RIGHT), "RIGHT");
        keycodeKeyMap.put(new Integer(KeyEvent.VK_UP), "UP");
        keycodeKeyMap.put(new Integer(KeyEvent.VK_DOWN), "DOWN");
    }
    ...
    private Object getKeySelection(final KeyEvent event) {
        ...
        } else if (event.getModifiers() == 0 && keycodeJoystickMap.containsKey(new Integer(keyCode))) {
